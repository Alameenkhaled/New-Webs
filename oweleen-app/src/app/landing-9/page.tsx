...
const LandingPage9 = () => {
  return (
    <div className="relative flex min-h-screen w-full flex-col">
      ...
      {/* Footer */}
      <footer className="w-full border-t border-gray-200/80 dark:border-gray-800/80 bg-background-light dark:bg-background-dark">
        <div className="container mx-auto px-4 py-6 md:px-6">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <p className="text-sm text-muted-light dark:text-muted-dark">© 2024 Oweleen. All rights reserved.</p>
            <div className="flex gap-4">
              <a className="text-sm text-muted-light dark:text-muted-dark hover:text-primary dark:hover:text-primary" href="#">Terms</a>
              <a className="text-sm text-muted-light dark:text-muted-dark hover:text-primary dark:hover:text-primary" href="#">Privacy</a>
              <a className="text-sm text-muted-light dark:text-muted-dark hover:text-primary dark:hover:text-primary" href="#">Contact</a>
            </div>
          </div>
        </div>
      </footer>
